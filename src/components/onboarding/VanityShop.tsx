...
export function VanityShop() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col">
      {/* 顶栏 — paddingTop 注入 safe-area-inset-top 避免被 iOS 刘海/Dynamic Island 盖住 */}
      <div
        className="sticky top-0 bg-zinc-950/90 backdrop-blur-md z-10 border-b border-zinc-900/50 px-4 py-3 flex items-center justify-between"
